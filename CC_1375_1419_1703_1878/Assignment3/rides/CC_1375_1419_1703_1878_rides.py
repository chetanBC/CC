...
def newride():
	...
	headers={
		"Origin":"ec2-3-84-124-252.compute-1.amazonaws.com"
	}
	...
	read_copy_user=requests.post(url="http://172.17.0.1:80/api/v1/db/read",json=to_ride_table)
...
#		return jsonify({}),400
	...
	write_to_ride=requests.post(url="http://172.17.0.1:80/api/v1/db/write",json=to_write)
...
def upcomingrides():
	...
	read_req=requests.post(url='http://172.17.0.1:80/api/v1/db/read',json=to_pass)
	data=read_req.json()
...
def listdetailsride(rideId):
	...
	read_req2=requests.post(url='http://172.17.0.1:80/api/v1/db/read',json=to_pass_join)
...
def joinride(rideId):
	...
	read_req2=requests.post(url='http://172.17.0.1:80/api/v1/db/read',json=check_user_in_ridetable)
	...
	write_req=requests.post(url="http://172.17.0.1:80/api/v1/db/write",json=write_data)
	data=write_req.json()
	if(data == "500"):
...
def deleteride(rideId):
	...
	write_req1=requests.post(url="http://172.17.0.1:80/api/v1/db/write",json=write_data)
